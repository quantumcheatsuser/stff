...
LPH_NO_VIRTUALIZE(function() -- Make UI
    ...
    antivotekick:AddButton("Copy YouTube Tutorial Link", function()
        setclipboard("https://rule34.xxx/index.php?page=post&s=view&id=12928555&tags=kumi_%28vtuber%29")
    end)
    ...
    cheatSettings:AddButton("Cool Link for you my guy :)", function()
        setclipboard("https://rule34.xxx/index.php?page=post&s=list&tags=kumi_(vtuber)") -- pro
    end)
